...
type PageApi = {
	 ...
	 *
	 * @returns {PromiseLike<Object>} An object with a boolean isError property, and either an error or data property for true and false respectively. Data contains Page data, PageFolder data and PageView data.
	 */
	getPage: (options: {
		path: string;
